...
/**
 * MinPQ,min priority queue
 */
public class ArrayMinPQ<Key extends Comparable<Key>> extends PriorityQueue<Key>{
     ...
     */
    public ArrayMinPQ(int N){
        array = (Key[]) new Comparable[N + 1];
    }

    /**
     * Create a minPQ from the keys in array[].
     */
    public ArrayMinPQ(Key[] array){
